...
from torchvision.models.detection.roi_heads import fastrcnn_loss, keypointrcnn_inference, keypointrcnn_loss, maskrcnn_inference, maskrcnn_loss
...
class AdsFasterRCNN(GeneralizedRCNN):
    """
...
class AdsRoIHeads(RoIHeads):
    def __init__(
        ...
        super().__init__(
            ...
            keypoint_roi_pool=keypoint_roi_pool, keypoint_head=keypoint_head, keypoint_predictor=keypoint_predictor)
    ...
    def forward(
        ...
        # get descriptors from targets
        descriptors = []
        for t in targets:
            descriptors.append(t["descriptors"])
