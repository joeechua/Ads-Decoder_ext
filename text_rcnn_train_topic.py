...
def train(num_classes: int, num_epochs: int,
    ...
    for epoch in range(start_epoch, start_epoch + num_epochs):
        ...
        # save checkpoint
        checkpoint_name = "outputs/cp_{}_tfasterrcnn_10ep.pth.tar"\
            .format(descriptor)
        utils.save_checkpoint(epoch, model, optimizer,
                              filename=checkpoint_name)

    metric_logs_med_name = "outputs/{}_10ep_train_metric_log_med.json"\
        .format(descriptor)
    metric_logs_avg_name = "outputs/{}_10ep_train_metric_log_avg.json"\
        .format(descriptor)
